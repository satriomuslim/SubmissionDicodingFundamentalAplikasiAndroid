...
import com.example.submissionkeduabaru.databinding.ActivityMainBinding
import com.example.submissionkeduabaru.main.detail.DetailUserActivity
import com.example.submissionkeduabaru.main.mode.ModeActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.getSeacrhUser().observe(this) {
            if (it != null)
                adapter.setList(it)
            showLoading(false)
        }
